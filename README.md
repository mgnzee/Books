...
This is my RESTful service for managing personal books and book collections between users, written in Java with Spring Boot.  
...
Note that this project is work in progress, there might be bugs. I plan to add user roles, more entities, cover it with tests and more.
